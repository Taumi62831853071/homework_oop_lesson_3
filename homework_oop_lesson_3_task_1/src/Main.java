...
public abstract class Main {
    ...
    public static void main(String[] args) {
        ...
        car1.setRegistrationNumber("a000aa000");
        car1.setWinterTires(false);
        car1.setFuelPercentage(91.01F);
        Car car2 = new Car(
                "Audi",
                "A8 50 L TDI quattro",
                3.0,
        ...
        car2.setRegistrationNumber("b111bb111");
        car2.setWinterTires(true);
        car1.setFuelPercentage(11.21F);
        Car car3 = new Car(
                "BMW",
                "Z8",
                3.0,
        ...
        car3.setRegistrationNumber("c222cc222");
        car3.setWinterTires(true);
        car1.setFuelPercentage(31.41F);
        ...
        car4.setRegistrationNumber("d333dd333");
        car4.setWinterTires(false);
        car1.setFuelPercentage(51.61F);
        Car car5 = new Car(
                "Hyundai",
                "Avante",
                1.6,
        ...
        car5.setRegistrationNumber("e444ee444");
        car5.setWinterTires(true);
        car1.setFuelPercentage(71.81F);
        printInfoCar(car1);
        car1.refill();
        printInfoCar(car2);
        car2.refill();
        ...
        train1.setFuelPercentage(92.02F);
        ...
        bus1.setWinterTires(false);
        bus1.setTravelCost(0);
        bus1.setFuelPercentage(100.0F);
        Bus bus2 = new Bus(
                "Паз",
                "Granbird",
                "белый",
        ...
        bus2.setWinterTires(true);
        bus2.setTravelCost(30);
        bus2.setFuelPercentage(12.34F);
        Bus bus3 = new Bus(
        ...
        bus3.setWinterTires(false);
        bus3.setTravelCost(436);
        bus2.setFuelPercentage(56.78F);
        printInfoBus(bus1);
        bus1.refill();
        printInfoBus(bus2);
        bus2.refill();
    ...
    private static void printInfoCar(Car car) {
        ...
        var10000.print(var10001 + " " + car.getModel() + ", год выпуска: " + car.getYear() + ", страна сборки: " +
                car.getCountry() + " цвет кузова: " + car.getBodyType() + " объём двигателя: " + car.getEngineVolume() +
                " коробка передач: " + car.getFuelPercentage() + " максимальная скорость " + car.getMaxSpeed() + " тип кузова " +
                car.getBodyType() + " рег. номер " + car.getRegistrationNumber() + " коллтчество мест: " +
                ...
                ", колличество топлива в процентах " + car.getFuelPercentage());
    }
    ...
    private static void printInfoTrain(Train train) {
        ...
        var10000.print("Поезд " + var10001 + ", модель " + train.getModel() + ", " + train.getYear() +
                ...
                train.getNumberOfWagons() + " вагонов., колличество топлива в процентах " + train.getFuelPercentage());
    }
    ...
    private static void printInfoBus(Bus bus) {
        ...
        var10000.print("Автобус " + var10001 + ", модель " + bus.getModel() + ", " + bus.getYear() +
                ...
                " резина, колличество топлива в процентах " + bus.getFuelPercentage());
    }
}